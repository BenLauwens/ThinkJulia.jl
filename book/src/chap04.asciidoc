...
It introduces turtle graphics, a way to create programmatically drawings. Turtle graphics are not included in the Standard Library, so the ThinkJulia module has to be added to your Julia setup.
