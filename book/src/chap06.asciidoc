...
As an example, suppose you want to find the distance between two points, given by the coordinates latexmath:[(x_1, y_1)] and latexmath:[(x_2, y_2)]. By the Pythagorean theorem, the distance is:
...
In <<sec14-5>> we will see a more flexible alternative to printing an error message: raising an exception.
