...
The alternative is to save code in a file called a _script_ and then run the REPL in _script mode_ to execute the script. By convention, Julia scripts have names that end with +.jl+.
(((script)))
(((script mode)))
