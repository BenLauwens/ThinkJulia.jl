...

{
    ...
    "category": "section",
    "text": "Julia provides functions that perform a variety of useful operations on strings. For example, the method uppercase takes a string and returns a new string with all uppercase letters.uppercase(\"Hello, World!\")As it turns out, there is a function named search that is remarkably similar to the function find we wrote:search(\"banana\", \'a\')Actually, the search function is more general than our function; it can find substrings, not just characters:search(\"banana\", \"na\")By default, search starts at the beginning of the string, but it can take a third argument, the index where it should start:search(\"banana\", \"na\", 4)This is an example of an optional argument."
},
