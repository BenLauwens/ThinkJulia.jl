...

{
    ...
    "title": "Encapsulation",
    "category": "section",
    "text": "The first exercise asks you to put your square-drawing code into a function definition and then call the function, passing the turtle as a parameter. Here is a solution:function square(t)\n    for i in 1:4\n        Forward(t, 100)\n        Turn(t, -90)\n    end\nend\n\nsquare(bob)The innermost statements, Forward and Turn are indented twice to show that they are inside the for loop, which is inside the function definition.Inside the function, t refers to the same turtle bob, so Turn(t, -90) has the same effect as Turn(bob, -90). In that case, why not call the parameter bob? The idea is that t can be any turtle, not just bob, so you could create a second turtle and pass it as an argument to square:alice = Turtle()\nsquare(alice)Wrapping a piece of code up in a function is called encapsulation. One of the benefits of encapsulation is that it attaches a name to the code, which serves as a kind of documentation. Another advantage is that if you re-use the code, it is more concise to call a function twice than to copy and paste the body!"
},
