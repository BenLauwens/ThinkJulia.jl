...
function fig11_2()
  ...
  \node at (5,-2.75){\tt fibonnaci};
  \node(f0n) at (4.5, -3.25){\tt n};
  \node(f0) at (5.5, -3.25){\tt 0};
  \draw[-latex] (f0n)--(f0);
  \node(fib111) [draw, fill=lightgray, minimum width=2cm, minimum height=1cm] at(-6.75,-4.5){};
  \node at (-6.75,-4.25){\tt fibonnaci};
  \node(f111n) at (-7.25, -4.75){\tt n};
  \node(f111) at (-6.25, -4.75){\tt 1};
  \draw[-latex] (f111n)--(f111);
  \node(fib00) [draw, fill=lightgray, minimum width=2cm, minimum height=1cm] at(-3.25,-4.5){};
  \node at (-3.25,-4.25){\tt fibonnaci};
  \node(f00n) at (-3.75, -4.75){\tt n};
  \node(f00) at (-2.75, -4.75){\tt 0};
  \draw[-latex] (f00n)--(f00);
